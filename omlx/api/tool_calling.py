...
# argument types as natively parsed calls (upstream #2332).
...
def _coerce_param_value(val: str, key: str, props: dict, func_name: str) -> Any:
    ...
    value is near-valid JSON (upstream #2332).  Parameters without a usable
    declared type keep the legacy best-effort JSON parse.
    """
    spec = props.get(key)
    ...
    if ptype in _SCHEMA_STRING_TYPES:
        ...
        # plain values stay verbatim (upstream 60e03c43).
        stripped = val.strip()
